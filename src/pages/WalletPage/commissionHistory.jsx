...
import { getAllEarningCommissionByUserId } from "../../apis/userServices";
...
const CommissionHistory = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await getAllEarningCommissionByUserId({
  ...
  const { payment, count, pagination } = apiResponse;
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden mb-6">
          <div className="px-6 py-4 border-b border-gray-700 bg-gray-800/50">
            ...
            <p className="text-sm text-gray-400 mt-1">
              ...
              {Math.min(currentPage * limit, count)} of {count} Request
            </p>
          </div>
                ...
                {payment?.map((user, index) => (
                  ...
                  >
                    ...
                    <td className="py-2 px-6">
                      <div className="flex items-center gap-2 text-gray-300">
                        {/* <Phone size={14} /> */}
                        <span className="text-sm">{user?.fromUserId?.username || "N/A"}</span>
                      </div>
                    </td>
                    {/* User Status */}
                    <td className="py-2 px-6">
