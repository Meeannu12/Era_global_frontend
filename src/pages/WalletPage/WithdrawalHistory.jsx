...
import { getAllWithdrawRequestByUserId } from "../../apis/userServices";
...
const DepositHistory = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await getAllWithdrawRequestByUserId({
